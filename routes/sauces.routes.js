...
router.get('/',auth,sauceCtrl.getAllSauce); // accès au controleur de la requête

router.post('/',auth,multer, // vérification de la conformité du fichier et stockage
...
router.get('/:id',auth, validation.idSauce, // vérification de la validité de l'id sauce de l'URL
                validationResult, // vérification de la présence d'erreur dans les entrées
                sauceCtrl.getOneSauce); // accès au controleur de la requête

router.put('/:id',auth,validation.idSauce, // vérification de la validité de l'id sauce de l'URL
                multer, // vérification de la conformité du fichier et stockage
                validation.sauce, // vérification des éléments descriptifs de la sauce
                validationResult, // vérification de la présence d'erreur dans les entrées
                sauceCtrl.modifySauce); // accès au controleur de la requête

router.delete('/:id',auth,validation.idSauce, // vérification de la validité de l'id sauce de l'URL
                validationResult, // vérification de la présence d'erreur dans les entrées
                sauceCtrl.deleteSauce); // accès au controleur de la requête

router.post('/:id/like',auth,validation.idSauce, // vérification de la validité de l'id sauce de l'URL
